$(document).ready(function() {
  ...
  $('#login-input').keypress(function(e) {
    if(e.which === 13 && $(this).val() != '') {
      ...
      setTimeout(function(){
        $('span').remove();
        $('#terminal').append('<br><div>Welcome to Hacking Game [version 1.0.0].<br>(c) Copyright 2014 Umm Corporation. All rights reserved.<br><br>' + player_name + ' authenticated.<br>HACKSYS ready for use.<br>Use the help command for a list of commands.<br><br><span id="initial-root">$</span>&nbsp;&nbsp;&nbsp;<span id="blinking">_</span></div>');
      }, 6500);
